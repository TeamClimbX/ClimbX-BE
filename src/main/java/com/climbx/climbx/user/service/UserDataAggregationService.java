...
public class UserDataAggregationService {
    ...
    public List<UserProfileResponseDto> buildProfilesBatch(List<UserAccountEntity> userAccounts) {
        ...
        // 배치 조회: 태그 요약 데이터
        Map<Long, List<TagRatingPairDto>> acceptedTagsMap = buildTagSummaryMap(userIds, StatusType.ACCEPTED);
    ...
    private RatingResponseDto buildRatingResponse(UserStatEntity userStat) {
        return RatingResponseDto.builder()
            ...
            .contributionRating(UserRatingUtil.calculateContributionScore(userStat.contributionCount()))
            .build();
    }
